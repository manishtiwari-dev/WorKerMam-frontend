<x-app-layout>
    ...
    <div class="contact-content">
        <div class="layout-specing">
            ...
            <form action="{{ route('app-reminder.setting.store') }}" method="POST" class="needs-validation" novalidate>
                @csrf
                <div class="card contact-content-body">
                    <div class="card-header">
                        <h6 class="tx-15 mg-b-0">Add</h6>
                    </div>
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-4 col-sm-4">
                                ...
                                <input name="interval" type="number" class="form-control" placeholder="Intervel" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                                ...
                                <textarea cols="40" rows="10" name="content" id="editor" class="form-control @error('content') is-invalid @enderror" required>
                                    {{-- {!! $data->content !!} --}}
                                </textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="">
                            <div class="col-sm-12 mb-3 mx-3 p-0">
                                <input type="submit" id="submit" name="send" class="btn btn-primary"
                                    value="Submit">
                                <a href="{{ route('app-reminder.setting.index') }}" class="btn btn-secondary mx-1">Cancel</a>
                            </div>
                        </div>
