        ...
        <div class="card contact-content-body">
            ...
            @endif --}}
                    ...
                    @if (\App\Helper\Helper::CheckPermission($pageAccess, 'add') == 'true')
                        <a href="{{ route('app-reminder.setting.create') }}" class="btn btn-sm btn-bg"><i
                ...
                <div class="row align-item-center mb-3 order-list-wrapper">
                    ...
                    <div class="col-lg-2 d-flex">
                        <div class="align-items-center ">
                            <a class="btn btn-primary px-5" href="{{ route('app-reminder.setting.index') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex align-items-center">
                                            ...
                                            @if (\App\Helper\Helper::CheckPermission($pageAccess, 'update') == 'true')
                                                <a href="{{ route('app-reminder.setting.edit', $remindData->id) }}"
        ...
        <script>
            ...
            $('.toggle-class').change(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    dataType: "json",
                    url: "{{ url('app-reminder/app-reminder-status') }}",
                    data: {
                        'status': status,
                        'id': id
                    },
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", ".deleteBtn", function() {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ url('app-reminder/app-reminder-delete') }}",
                        data: {
                            id: id,
                        },
                        dataType: "json",
            ...
            function tableWebContent(startDate = '', endDate = '', search = '') {
                ...
                const url = "{{ route('app-reminder.ReminderFilter') }}";
                $.ajaxSetup({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    }
