<x-app-layout>
    ...
    <div class="contact-content">
        <div class="layout-specing">
            <form action="{{route('excel.employee-import-store')}}" id="import-work-report-data-form" enctype="multipart/form-data" method="POST"
                ...
                <div class="card contact-content-body">
                    ...
                    <div class="card-header bg-transparent">
                        <div class="d-flex align-items-center justify-content-between ">
                            <h6 class="tx-15 mg-b-0">Import Employee</h6>
                        </div>
                    </div>
                ...
                <div class="mt-3">
                    <div class="col-sm-12 p-0">
                        <input type="submit" id="import-work-report-form" name="send" class="btn btn-primary"
                            value="{{ __('seo.upload') }}">
                        <a href="{{ route('excel.employee.index') }}"
