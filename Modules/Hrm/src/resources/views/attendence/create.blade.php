                        ...
                        <div data-label="Example" class="df-example demo-forms">
                            <div class="form-row">
                                <div class="form-group col-md-4 ">
                                    <label class="form-label">{{ __('hrm.department') }} <span class="text-danger mg-l-5">*</span></label>
                                    <select class="form-control department select2 @error('leave_type_id') is-invalid @enderror "
                                ...
                                <div class="form-group col-md-4 skillselect">
                                    <label class="form-label">{{ __('hrm.staff') }} </label>
                                    <select
                                        class="form-control select2  selectuser @error('id') is-invalid @enderror select2"
                                ...
                                <div class="form-group col-md-4 ">
                                    ...
                                    <select class="form-control select2 @error('id') is-invalid @enderror "
                                        id="status" name="working_from" required>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3" id="select_date">
                                    <label class="form-label">{{ __('hrm.select_date') }} <span
                                            class="text-danger mg-l-5">*</span></label>
                                    <input name="attendence_date" value="{{\Carbon\Carbon::now()->format('m/d/Y')}}" id="" type=""
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="check_in" name="clock_in_time"
                                            ...
                                            required onclick="showpickers('check_in',24)">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" id="check_out" name="clock_out_time"
                                            ...
                                            aria-label="Recipient's username" aria-describedby="basic-addon2"
                                            required onclick="showpickers('check_out',24)">
                                        <div class="input-group-append">
                                            <button class="btn btn-outline-secondary"
                                ...
                                <div class="form-group col-md-2 mt-4 ">
                                    <label class="form-label">{{ __('hrm.late') }} <span
                                            class="text-danger mg-l-5"></label><br />
                                    <input type="radio" id="contactChoice1" name="late" value="yes" required>
                                    <label for="Choice1">Yes</label>
                                    <input type="radio" id="contactChoice2" name="late" value="no" required>
                                ...
                                <div class="form-group col-md-2 mt-4">
                                    ...
                                    <input type="radio" id="contactChoice1" name="half_day" value="yes" required>
                                    <label for="Choice1">Yes</label>
                                    <input type="radio" id="contactChoice2" name="half_day" value="no" required>
                                    <label for="Choice2">No</label>
                    ...
                    success: function(response) {
                        ...
                        if ((response[0].user_list != '')) {
                            ...
                            $.each(response[0].user_list, function(key, user) {
                                console.log(user);
                                html += `  <option value="${user.staff_id } ">  
