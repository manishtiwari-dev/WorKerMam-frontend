    ...
    <div class="contact-content">
        <div class="layout-specing">
            ...
            <div class="card contact-content-body">
                <form action="{{ url('hrm/setting/leave-store') }}" id="userForm" method="POST" class="needs-validation"
                    novalidate>
                    @csrf
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6 col-6">
                                    ...
                                    <input type="number" class="form-control"
                                        placeholder="{{ __('hrm.no_of_days_placeholder') }}" name="no_of_days" required>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 col-6 mb-0">
                                    <label class="form-label">{{ __('hrm.max_allowed') }} <span
                                            class="text-danger mg-l-5">*</span></label>
                                    <input type="number" class="form-control" name="max_allowed"
                                        placeholder="{{ __('hrm.max_allowed_placeholder') }}" required>
                                ...
                                <div class="form-group col-md-6 col-6 mb-0">
                                    ...
                                    <textarea name="leave_info" rows="1" value="" class="form-control"></textarea>
                                    <div class="invalid-feedback">
