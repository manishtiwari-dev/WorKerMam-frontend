<x-app-layout>
    ...
    <div class="contact-content">
        <div class="layout-specing">
            ...
            <form action="{{ route('marketing.contact_add') }}" method="POST" id="add_contact_list_form" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3 d-flex ">
                            <div class="col-lg-1 p-0">
                                <input type="submit" name="send" class="btn btn-primary" id="ContactSubBtn" value="{{ __('common.submit')}}">
                            </div>
                            <div class="col-lg-1 p-0">
                                <input type="submit" name="send" class="btn btn-light" value="{{ __('common.cancel')}}">
                            </div>
                        </div>
                    </div>
                </div>
