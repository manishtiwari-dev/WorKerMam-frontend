                                ...
                                <div class="form-icon position-relative"> 
                                    <select class="form-select form-control select2"  name="contact_group" id="contact_group"
                                        ...
                                        @foreach($group_data as $gName)
                                            <option value="{{$gName->id}}" {{ ($gName->id == $data_list->contact->group_id) ? 'selected' : '' }}>{{$gName->group_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-icon position-relative">
                                    <select class="form-select form-control select2" name="country" id="country"
                                        ...
                                        @foreach($countrydata as $country)
                                            <option value="{{$country->countries_id}}" {{($country->countries_id == $data_list->countries_id) ? 'selected' : ''}}>{{$country->countries_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
