...
class FrontJobsController extends BaseController
{
    ...
    public function jobDetail($slug)
    {
         ...
         $apiurl = config('apipath.front-job-jobDetail');
         $responseData = Helper::ApiServiceResponse($apiurl, $parameters);
         dd($responseData);


         return view('Recruit::front.job-detail', collect($responseData->data));
