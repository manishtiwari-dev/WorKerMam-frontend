    ...
    <form id="createSchedule" class="ajax-form" method="post">
        ...
        <div class="form-body">
            <div class="row">
                ...
                <div class="col-md-6 col-xs-12 select-dropdown">
                    <div class="form-group">
                        <label class="d-block">@lang('modules.interviewSchedule.employee')</label>
                        <select class="m-b-10 form-control select2 " multiple="multiple"
                            ...
                            @foreach($users as $emp) 
                                <option value="{{ $emp->id }}">{{ ucwords($emp->first_name) }}   </option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                          ...
                          <select class="select2 form-control" id="created_by" name="created_by">
                              @foreach($users as $emp)
                                  <option @if($emp->id == $user)
                                      selected
                                      @endif value="{{ $emp->id }}">{{ ucwords($emp->first_name) }} {{ ucwords($emp->last_name) }}</option>
                              @endforeach
                          </select>
                    </div>
                </div>
...
<script>
    ...
    $('.save-schedule').click(function () {
        $.ajax({
            url: '{{route('recruit.job-applications.store-schedule')}}',
