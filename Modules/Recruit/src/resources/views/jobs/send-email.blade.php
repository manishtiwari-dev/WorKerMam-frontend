<x-app-layout>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between ">
                        <h6 class="tx-15 mg-b-0">{{ __('modules.sendmail') }}</h6>
                                ...
                                <div class="col-md-8">
                                    <form id="send-email-form" method="POST">
                                        <div class="form-group mb-0">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <select class="select2 mailstatus" name="mail_status"
                                                        id="mail-status" data-style="form-control">
                                                ...
                                                <div class="col-lg-4">
                                                    <select class="select2 " name="job_for_email" id="job-for-email"
                                                ...
                                                <div class="col-lg-4">
                                                    <button type="button" id="send-emails"
                                                        class="btn btn-sm btn-warning w-100"><i
                                                            class="fa fa-envelope-o"></i>
                                                        @lang('app.sendEmails')</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                    ...
                    <div class="row b-b b-t mb-3" style="display: none; background: #fbfbfb;" id="ticket-filters">
                        <div class="col-md-12">
                            <h4 class="mt-2">@lang('app.filterBy') <a href="javascript:;"
                                    class="pull-right mt-2 mr-2 toggle-filter"><i class="fa fa-times-circle-o"></i></a>
                            </h4>
                        </div>
                        <div class="col-md-12">
                                        ...
                                        <select class="select2" name="location" id="location"
                                            ...
                                            @forelse($locations as $location)
                                                <option value="{{ $location->id }}">
                                                    {{ ucfirst($location->location) }}</option>
                                            @empty
                                            @endforelse
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-11">
                                                <select class="select2 select2-multiple" name="skill[]"
    ...
    {{-- Ajax Modal --}}
    <div class="modal fade bs-modal-md in" id="mail-confirm-modal" role="dialog" aria-labelledby="myModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-md" id="modal-data-application">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex flex-column align-items-center">
                    ...
                    <div>
                        <button type="button" class="btn dark btn-outline mr-2"
                            data-bs-dismiss="modal">@lang('app.cancel')</button>
                        <button type="button" class="btn btn-success"
                            id="send-emails-confirm">@lang('app.sendEmails')</button>
                    </div>
                </div>
    ...
    <div class="modal fade job_application" id="job_application" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content tx-14">
                ...
                <div class="modal-body send-mail">
    ...
    <script src="https://cdn.datatables.net/fixedheader/3.2.0/js/dataTables.fixedHeader.min.js"></script>
        ...
        <script>
            ...
            function tableLoad(type) {
                if (type == 'load') {
                    table = $('#myTable').DataTable({
                        ...
                        ajax: {
                            'url': '{!! route('recruit.jobs.applicationData') !!}',
                            'data': function(d) {
                                d.status = $('#status').val();
            ...
            $('#myTable tbody').on('change', 'input', function() {
                ...
                if ($('#myTable tbody input:checked').length == tableData.page.info().end - tableData.page.info()
                    .start) {
                    $('input#select-all').prop('checked', true);
                    toggleText('show');
                } else {
            ...
            $('#send-emails-confirm').click(function() {
                ...
                $.ajax({
                    url: '{{ route('recruit.jobs.sendEmails') }}',
                    type: 'POST',
                    data: filterData,
            ...
            $('#send-emails').click(function(e) {
                ...
                if (allSelected || selected.length > 0) {
                    ...
                    text = text.replace(':selectedApplicantsCount', allSelected ? tableData.page.info().recordsTotal :
                        selected.length);
                    ...
                    Toaster('error', 'Please select applicants before sending emails.');
                }
            })
