            ...
            <tbody>
                @forelse($workExperiences as $key=>$workExperience)
                    <tr id="dept-{{ $workExperience->id }}">
                        ...
                        <td>
                            <a href="javascript:;" data-dept-id="{{ $workExperience->id }}"
    ...
    <form id="createdepartment" class="ajax-form" method="post">
        ...
        <script>
            ...
            $('#save-department').click(function() {
                $.ajax({
                    url: '{{ route('recruit.work-experience.store') }}',
            ...
            $('#update-department').click(function() {
                var id = $('#edit_id').val();
                var url = "{{ route('recruit.work-experience.update', ':id') }}";
                ...
                swal({
                    ...
                    .then((isConfirm) => {
                        if (isConfirm) {
                            ...
                            var url = "{{ route('recruit.work-experience.destroy', ':id') }}";
                            url = url.replace(':id', id);
