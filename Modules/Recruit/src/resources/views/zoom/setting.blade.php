    ...
    <div class="contact-content">
        <div class="contact-content-header mg-b-20 mg-lg-b-25 mg-xl-b-30">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" id="job-category"><a href="#job-category"
                        class="nav-link {{ request()->tab == 'job-category' || !isset(request()->tab) ? 'active' : '' }} "
                        data-bs-toggle="tab">{{ __('modules.job_category') }}</a></li>
                <li class="nav-item" id="skills"> <a href="#skills" class="nav-link {{ request()->tab == 'skills' ? 'active' : '' }}"
                        data-bs-toggle="tab">{{ __('modules.skills') }}</a></li>
                <li class="nav-item" id="location"><a href="#location"
                                                    ...
                                                    @forelse($content->job_category as $key => $category)
                                                        <tr>
                                                            ...
                                                            @if (\App\Helper\Helper::CheckPermission($pageAccess, 'remove') == 'true')
                                                                <a href="javascript:void(0)" data-bs-dismiss="modal"  data-bs-toggle="modal" id="delete_cate"
                                                ...
                                                <tbody>
                                                    @forelse($content->skills as $key => $skill)
                                                        <tr>
                                                            ...
                                                            @endif
                                                            @if (\App\Helper\Helper::CheckPermission($pageAccess, 'remove') == 'true')
                                                                <a href="javascript:void(0)" data-bs-dismiss="modal"  data-bs-toggle="modal" id="delete_skill"
                                                ...
                                                <tbody>
                                                    @forelse ($content->locations as $key => $location)
                                                        <tr>
                                                            ...
                                                            @endif
                                                            @if (\App\Helper\Helper::CheckPermission($pageAccess, 'remove') == 'true')
                                                                <a href="javascript:void(0)" data-bs-dismiss="modal"  data-bs-toggle="modal" id="delete_btn"
    ...
    @push('scripts')
        ...
        <script>
            ...
            $('#job-category').click(function() {
                window.location.href = "{{ route('recruit.setting.index', ['tab=job-category']) }}";
            });
            $('#skills').click(function() {
                window.location.href = "{{ route('recruit.setting.index', ['tab=skills']) }}";
            });
            $('#location').click(function() {
                window.location.href = "{{ route('recruit.setting.index', ['tab=location']) }}";
            });
            $('#zoom-setting').click(function() {
