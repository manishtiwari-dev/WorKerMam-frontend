...
<!-- 
        ...
        @push('scripts')
            ...
            <script type="text/javascript" charset="utf8" src="{{ asset('asset/js/dataTables.fixedHeader.min.js') }}"></script>
            {{-- <script type="text/javascript" charset="utf8" src="{{ asset('asset/js/dataTables.responsive.min.js') }}"></script> --}}
