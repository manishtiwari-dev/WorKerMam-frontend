            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between ">
                        <h6 class="tx-15 mg-b-0">Onboard Offer Question</h6>
                        <a href="{{ route('recruit.job-onboard-questions.create') }}"
                            class="btn btn-sm btn-bg d-flex align-items-center mg-r-5"><i data-feather="plus"></i><span
                                class="d-none d-sm-inline mg-l-5"> @lang('app.createNew')</span></a>
                ...
                <div class="card-body">
                    <div class="row clearfix">
                        <div class="col-md-12 mb-20">
                            ...
                            <a href="{{ route('recruit.job-onboard.index') }}"><button class="btn btn-sm btn-primary"
                                    type="button">
            ...
            <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between ">
                            <h6 class="tx-15 mg-b-0">Onboard Offer Question</h6>
                            <a href="{{ route('recruit.job-onboard-questions.create') }}"
                                class="btn btn-sm btn-primary d-flex align-items-center mg-r-5"><i data-feather="plus"></i><span
                                    class="d-none d-sm-inline mg-l-5"> @lang('app.createNew')</span></a>
                                    ...
                                    @if(!empty($content->questions))
                                        @forelse($content->questions as $key=>$question)
                                            <tr>
                                                ...
                                                <td style="width:25%;" class="d-flex justify-content-center">
                                                        <a href="{{route('recruit.job-onboard-questions.edit', [$question->id])}}"
                                                        ...
                                                        <a href="" id="delete_btn" data-id="{{ $question->id }}" value="" data-toggle="modal" class="btn btn-sm btn-white d-flex align-items-center"><svg
                                                        viewBox="0 0 24 24" width="24" height="24"
                                                        stroke="currentColor" stroke-width="2" fill="none"
                                                        stroke-linecap="round" stroke-linejoin="round"
                                                        class="css-i6dzq1">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="delete_onboard_offer" name="input_field_id">
    ...
    @push('scripts') 
        <script>
            ...
            $(document).on("click", "#delete_btn", function() {
                var onboard_offer = $(this).attr("data-id");

                $('#delete_onboard_offer').val(onboard_offer);
                $('#delete_modal').modal('show');
            });

            $(document).on('click', '.delete_submit_btn', function() {
                var onboard_offer = $('#delete_onboard_offer').val()
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ url('recruit/job-onboard-questions') }}/" + onboard_offer,
                    data: {
                        onboard_offer: onboard_offer,
                        _method: 'DELETE'
                    },
                    dataType: "json",
                    success: function(response) {
                        if (response.success) {
                            ...
                            window.location.href =
                                "{{ route('recruit.job-onboard-questions.index') }}";
