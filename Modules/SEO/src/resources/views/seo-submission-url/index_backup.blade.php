                    ...
                    <div class="d-flex align-items-center justify-content-between ">
                        ...
                        @if (\App\Helper\Helper::CheckPermission($pageAccess, 'add') == 'true')
                            <a href="{{ route('seo.submission-url.create') }}"
                                ...
                                <span
                                    class=" d-sm-inline mg-l-5">{{ __('seo.add_submission') }}</span></a>
                        @endif
                    </div>
                </div>
                                        ...
                                        @if (!empty($content->websitelist))
                                            @foreach ($content->websitelist as $website => $websitename)
                                                <option value="{{ $websitename[0]->id }}"
                                                    {{ request()->website == $websitename[0]->id ? 'selected' : '' }}>
                                                    ...
                                                    <td>
                                                        <div class="custom-control custom-switch">
                                                            <input data-id="${seosubmission.id}" class="custom-control-input toggle-class"
                                                                id="customSwitch{{ $seosubmission->id}}_{{$task->id}}" type="checkbox" {{ $seosubmission->status ==1
                                                                ? 'checked' : '' }}>
                                                            <label class="custom-control-label" for="customSwitch{{ $seosubmission->id}}_{{$task->id}}"></label>
                                                        </div>
                                                    </td>
                                                    <td class="d-flex align-items-center">
                                                        <a href="{{$editUrl}}" class="btn btn-sm btn-white d-flex align-items-center mg-r-5"><svg
                                                        ...
                                                        <a href="#delete_modal" id="delete_btn" data-id="{{ $deleteUrl}}" value=""
                                                            data-toggle="modal" class="btn btn-sm btn-white d-flex align-items-center"><svg
                                                                viewBox="0 0 24 24" width="24" height="24" stroke="currentColor"
                                                                stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"
                                                                class="css-i6dzq1">
