        ...
        <div data-label="Example" class="df-example demo-forms">
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="form-icon position-relative">
                        <select
                            class="form-select form-control select2Modal @error('website') is-invalid @enderror"
                            id="website" name="website_id" aria-label="Default select example" required
                            disabled>
                            <option selected value>{{ __('seo.select_website') }}</option>
                            @if (!empty($websites))
                            @foreach ($websites as $website)
                            <option value="{{ $website->id }}" {{($web_name==$website->website_name) ?
                                'selected':''}}>{{ $website->website_name }}
                            </option>
                            @endforeach
                            @endif
                        </select>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-icon position-relative">
                        {{-- @dd($seotask) --}}
                        <select
                            class="form-select form-control select2Modal @error('seotask') is-invalid @enderror"
                            ...
                            <option value="{{ $seotasklist->id }}" {{($task_id==$seotasklist->id) ?
                                'selected':''}}>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="website_url" id="website_url" type="text"
                        ...
                        placeholder="{{ __('seo.website_url_placeholder') }}" onblur="extractBaseUrl(this)" required>
                    <div class="invalid-feedback">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="username" value="{{ old('website_username') }}"
                        id="website_username" class="form-control"
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input type="number" name="da" value="{{ old('da') }}" id="da" class="form-control"
                        placeholder="{{ __('seo.da_placeholder') }}" onblur="DomainVal(this)">
                    <p id="errorMsg" style="color: red; display: none;">Please Enter Minimum of 100</p>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <input type="text" name="spam_score" value="{{ old('spam_score') }}"
                        ...
                        placeholder="{{ __('seo.spam_score_placeholder') }}" onblur="spamVal(this)">
                        <div id="errorSpamMsg" style="color: red; display: none;">Please Enter Minimum of 10</div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input toggle_class" data-id=""
                            id="customSwitch2">
