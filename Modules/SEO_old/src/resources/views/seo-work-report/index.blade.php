                        ...
                        <div data-label="Example" class="df-example demo-table">
                            ...
                            <div class="table-responsive ">
                                <table class="table  table_wrapper allWebsite" id="website_listing">
                                    <thead>
                                        <tr>
                                            <th>{{ __('seo.task_title') }}</th>
                                            <th>{{ __('seo.website_url') }}</th>
                                            <th>{{ __('seo.username') }}</th>
                                            <th>{{ __('seo.password') }}</th>
                        ...
                        $.each(result.work_report.seo_task, function(seokey, values) {
                            ...
                            if (seo_id.indexOf(values.id) !== -1) {
                                ...
                                $.each(result.work_report.work_report, function(key, value) {
                                    ...
                                    html += `<tr>
                                        <td></td>
                                        <td><a data-toggle="tooltip" data-placement="top" title="${web_url}" href="https://${web_url}" target="_blank">   ${web_url.slice(0, char) + (web_url.length > char ? "..." : "")} </a></td>
                                        <td><a data-toggle="tooltip" data-placement="top" title="${value.url}" href="https://${value.url}" target="_blank">
                                        ${char_value.slice(0, char) + (char_value.length > char ? "..." : "")} </a></td>

                                        <td><a data-toggle="tooltip" data-placement="top" title="${land_url}" href="https://${(value.landing_url != null) ? value.landing_url : ''}" target="_blank">  ${land_url.slice(0, char) + (land_url.length > char ? "..." : "")} </a></td>
                                        <td>${(value.submission_date != null) ? value.submission_date : ''}</td>
                                    </tr>
                                        `;
                                });
