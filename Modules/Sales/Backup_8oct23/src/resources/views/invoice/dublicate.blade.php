    ...
    <div class="card">
        ...
        <form method="post" class="needs-validation" autocomplete="off"
                ...
                <div class="card-header d-flex align-items-center justify-content-between py-2 px-3">
                    <h6 class="tx-15 mb-0">Dublicate Invoice</h6>
                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker1" name="invoice_date"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control datepicker1" name="due_date"
                                    value="  {{ \Carbon\Carbon::parse($content->app_invoice->due_date)->format('d/m/Y') }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-5 mb-3 mb-lg-0">
                   ...
                   <!--Customer Address Start-->
                    <div class="form-group row my-0 my-lg-2">
                        <label for="inputPassword"
                            class="col-sm-12 col-lg-12 col-form-label">{{ __('crm.customer_address') }}</label>
                            ...
                            if (response != '') { 
                                ...
                                html += ` 
                                            <tr class="addmore">
                                                ...
                                                <td>
                                                    <input name="taxable_amount[]" type="text" value="${response.item_price}" class="form-control taxable_amount"
