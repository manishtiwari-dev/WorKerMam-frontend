                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" placeholder="{{ __('sales.sent_amount_placeholder') }}"
                                                name="sent_amt" id="sent_amount" class="form-control" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" placeholder="{{ __('sales.received_amount_placeholder') }}"
                                                name="received_amt" id="received_amount" class="form-control" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" placeholder="{{ __('sales.charges_placeholder') }}"
                                                name="charges" id="charges" class="form-control" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" placeholder="{{ __('sales.exchange_rate_placeholder') }}"
                                                name="exchange_rate" id="exchange_rate" class="form-control" />
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" placeholder="{{ __('sales.bank_charge_placeholder') }}"
                                                name="bank_charge" id="bank_charge" class="form-control" />
