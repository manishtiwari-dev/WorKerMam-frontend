    ...
    <table cellspacing="0" cellpadding="0" class="invoice-wrapper">
        <tr>
            <td rowspan="3" style="width:400px; border: none;">
                <div class="text-black" style="font-size: 22px;font-weight: 600;">TAX INVOICE</div>
            </td>
    ...
    <table cellspacing="0" cellpadding="0" border>
        @if ($data->invoice_type != 'services')
            ...
            <tr>
                ...
                <td colspan="5">
                    {{ $data->quote_detail->customer->company_name != '' ? $data->quote_detail->customer->company_name : $data->quote_detail->customer->customer_name }}
                </td>
                <td colspan="5">
                    {{ $data->quote_detail->customer->company_name != '' ? $data->quote_detail->customer->company_name : $data->quote_detail->customer->customer_name }}
                </td>
