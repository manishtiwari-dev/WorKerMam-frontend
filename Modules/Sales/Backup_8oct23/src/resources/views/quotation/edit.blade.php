<x-app-layout>
    ...
    <div class="card">
        <div class="tab-content add-quotation-wrapper">
            <form action="{{route('sales.quotation.update',$quotation->quotation_id)}}" method="post" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                                                        ...
                                                        <td colspan="7">
                                                            ...
                                                            <table>
                                                                ...
                                                                <td style="min-width:290px;">
                                                                    <input name="item_name[]" type="text" class="form-control" id="itemName_1456823664{{$quoteItem->product_data->product_id}}" placeholder="Item Name" value="{{$quoteItem->product_data->products_name}}" required="">
                                                                        <input type="hidden" name="item_id[]" value="{{$quoteItem->product_data->product_id}}">
                                                                        <div class="invalid-feedback">
                                                                            {{ __('crm.item_name_error') }}
                                                                    </div>
                                                                </td>
                                                                <input type="hidden" value="{{json_encode($quoteItem->product_data->product_attribute)}}" class="editProductAttr">
                                                                <td class="text-center ">
                                                                    <input name="quantity[]" type="text" class="form-control quantity" id="quantity_1456823664{{$quoteItem->product_data->product_id}}" placeholder="Qty" value="{{$quoteItem->quantity}}" onblur="calculation({{'1456823664'.$quoteItem->product_data->product_id}})" required="">
                                                                    <div class="invalid-feedback">
                                                                        {{ __('crm.quantity_error') }}
                                                                    </div>
                                                                </td>
                                                                <td class="text-center ">
                                                                    <input name="unit_price[]" type="text" onkeyup="calculation({{'1456823664'.$quoteItem->product_data->product_id,'',''}})" class="form-control unit_price" id="unit_price_1456823664{{$quoteItem->product_data->product_id}}" placeholder="Unit Price" value="{{$quoteItem->unit_price ?? ''}}">
                                                                    <div class="invalid-feedback">
                                                                ...
                                                                <input type="hidden" value="{{$quoteItem->product_data->product_qty}}"  id="min_prod_qty_1456823664{{$quoteItem->product_data->product_id}}">
                                                                <input type="hidden" value='{{json_encode($quoteItem->product_data->bulkPrice)}}' data="json" id="bulk_price_1456823664{{$quoteItem->product_data->product_id}}">

                                                                <td class="text-center">
                                                                    <input name="discount[]" type="text" class="form-control discount" id="discount_1456823664{{$quoteItem->product_data->product_id}}" onkeyup="discount({{'1456823664'.$quoteItem->product_data->product_id}})" placeholder="Discount" value="{{$quoteItem->discount ?? ''}}">
                                                                    <div class="invalid-feedback">
                                                                        {{ __('crm.discount_error') }}
                                                                    </div>
                                                                </td>
                                                                <td class="text-center tax_outer">    
                                                                    <select class="form-select form-control tax  tax_dropdown select2" onchange="calculation({{'1456823664'.$quoteItem->product_data->product_id}})" name="tax_group_id[]" id="tax_1456823664{{$quoteItem->product_data->product_id}}">
                                                                    <!--Optionn Show from jquery-->  
                                                                    @if (!empty($TaxGroup))
                                                                        @foreach ($TaxGroup as $taxgrp_data)
                                                                            <option value="{{ $taxgrp_data->tax_group_id }}" {{$taxgrp_data->tax_group_id == $quoteItem->tax_group_id ? 'selected' :''}}> 
                                                                ...
                                                                <td class="text-center ">
                                                                    <input name="item_cost[]" type="text" class="form-control amount" id="amount_1456823664{{$quoteItem->product_data->product_id}}" placeholder="Amount" value="{{$quoteItem->item_cost}}" readonly="" required="">
                                                                    <div class="invalid-feedback">
                                                                        {{ __('crm.amount_error') }}
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                <button type="button" class="btn btn-danger btn-sm remove" value="1456823664{{$quoteItem->product_data->product_id}}"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                                                           ...
                                                           @if($quoteItem->product_data->productAttribute)
                                                                <table>
                                                                    <tbody>
                                                                        <tr>
                                                                            @php
                                                                               $dbAttribute= !empty($quoteItem->attributes) ? json_decode($quoteItem->attributes) :NULL;
                                                                            @endphp
                                                                           ...
                                                                           @foreach($quoteItem->product_data->productAttribute as $key=>$attribute)
                                                                            <td style="min-width:300px;">
                                                                                <div class="form-group row">
                                                                                    ...
                                                                                    <select data="{{$attribute->products_id}}_{{$quoteItem->product_data->sale_price}}" name="item_attributes[{{$attribute->products_id}}][]" id="attribute_1456823664{{$quoteItem->product_data->product_id}}" class="form-control col-lg-5 product_attributes">
                                                                                        
                                                                                        @foreach($attribute->option_value_list as $optionvalues)
                                                                                            <option  value="{{$attribute->options_id}}_{{ $optionvalues->options_values_id }}" >{{$optionvalues->product_options_value->products_options_values_name}}</option>
                                                                                        @endforeach
                                                        ...
                                                        <tr class="addmore">
                                                            ...
                                                            <td class="text-center ">
                                                                <input name="quantity[]" type="number"
                                                                    class="form-control quantity" id="quantity_{{$key+1}}" placeholder="{{ __('crm.qty') }}"
                                                                    value="{{$quoteItem->quantity ?? ''}}" onblur="calculation({{$key+1}})" required>
                                                                <div class="invalid-feedback">
                                                                    {{ __('crm.quantity_error') }}
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="text-center tax_outer">
                                                                <select class="form-select form-control tax select2 tax_dropdown" onchange="calculation({{$key+1}})" name="tax_group_id[]" id="tax_{{$key+1}}">
                                                                <option selected  value="" >{{ __('crm.select') }}</option>
                                                                @if (!empty($TaxGroup))
                                                                    @foreach ($TaxGroup as $taxgrp_data)
