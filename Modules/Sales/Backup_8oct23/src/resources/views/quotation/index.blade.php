                            ...
                            @if (!empty($content->quotation_list))
                                @foreach ($content->quotation_list as $key => $quotation)
                                    <tr>
                                        ...
                                        <select class="form-select form-control change_status select2" id="customSwitch" name="status_name"  data-id="{{$quotation->quotation_id}}">
                                        ...
                                        <a href="{{ route('sales.quotation.edit', $quotation->quotation_id) }}" class="btn btn-sm btn-white table_btn py-1 px-2"> <i class="fa fa-pencil" ></i></a>
                                        @endif
