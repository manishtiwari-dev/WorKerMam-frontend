...
class TransactionController extends BaseController
{
   public function __construct()
   {
      ...
      // $this->pageCalendarAccess = config('acceskey.calendar');
   }
   ...
   {
      $this->pageCalendarAccess = config('acceskey.sales-calendar');
      ...
      // Add $this->pageCalendarAccess to the data array
      $this->data['pageCalendarAccess'] = $this->pageCalendarAccess;

      // dd($this->data);
      return view('Sales::transaction.calendar', collect($this->data));
   }
