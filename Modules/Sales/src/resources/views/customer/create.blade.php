                                ...
                                <div class="form-row row">
                                    <div class="form-group col-md-4 col-lg-4 col-12">
                                        ...
                                        <select class="form-control form-select select2 @error('lead_id') is-invalid @enderror "
                                            ...
                                            @forelse ($lead as $leads)
                                                <option value="{{ $leads->lead_id }}" {{ old('lead_id') == $leads->lead_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group col-md-4 col-lg-4 col-12">
                                        ...
                                        <input type="email" id="email" class="form-control"
                                            placeholder="{{ __('crm.customer_email_placeholder') }}" name="email" value="{{ old('email') }}" 
                                            required>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="form-group col-md-4 col-sm-12">
                                        ...
                                        <input type="text" value="{{ old('company_name') }}" class="form-control" id="company_name" name="company_name"
                                    ...
                                    <div class="form-group col-lg-4 col-md-6  col-12">
                                        ...
                                        <input type="text" name="tax_id" value="{{ old('tax_id') }}" placeholder="Enter Tax Id" class="form-control">
                                    </div>
                            ...
                            <fieldset class="form-fieldset">
                                ...
                                <div class="form-row row">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-lg-4 col-12">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('street_address') }}" name="street_address"
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-lg-4 col-12">
                                        ...
                                        <select
                                            ...
                                            <option value="{{ $countries->countries_id }}" {{ old('countries_id') == $countries->countries_id ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-lg-4 col-12">
                                        ...
                                        <input type="text"value="{{ old('zipcode') }}" class="form-control" id="zipcode" name="zipcode"
