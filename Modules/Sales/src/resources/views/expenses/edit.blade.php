<x-app-layout>
    ...
    <div class="">
        <div class="tab-content">
            <form action="{{ route('sales.expenses.update', $appTransaction->id) }}" method="post" class="needs-validation"
                novalidate>
                @csrf
                @method('PUT')
                    ...
                    <div class="row mt-3">
                        <div class="col-md-4 col-lg-4 col-6 mx-sm-auto ml-md-0">
                            <input type="submit" id="submit" name="send" class="btn btn-primary"
                                value="Submit">
                            <a href="{{ route('sales.expenses.index') }}" class="btn btn-secondary mx-1">Cancel</a>
                        </div>
                    </div>
                    <!--end row-->
                </div>
