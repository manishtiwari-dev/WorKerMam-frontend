                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="INVOICE" name="invoice_title">
                            </div>
                        </div>
                        ...
                        <div class="card-body mt-4">
                                ...
                                <table class="table table_wrapper create_table">
                                        ...
                                        <tr class="addmore">
                                            ...
                                            <td class="text-center">
                                                <input name="discount[]" type="number" class="form-control discount"
                                                    ...
                                                    placeholder="  {{ __('crm.discount') }}" value="0"
                                                    step="any">
                                                <div class="invalid-feedback">
                                            ...
                                            <td class="text-center">
                                                <input name="item_cost[]" type="text" class="form-control amount"
                                                    id="amount_1" placeholder="{{ __('crm.amount') }}"
                                    ...
                                    <tbody class="border-top">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <input name="final" id="total_cost" type="number"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12 pt-3 ps-4">
                                    ...
                                    <input name="shipping_cost" type="number" value="0" class="form-control"
                                ...
                                <div class="col-lg-4 col-sm-12 pt-3 ps-4">
                                    <label for="quotation_label"
                                        class="form-label">{{ __('crm.payment_term') }}</label>
                                    <select class="form-select form-control payment_term_id" id="payment_term_id"
                        ...
                        <div>
                                ...
                                <div
                                    ...
                                    <div class="dropdown_search w-50">
                                        <div class="d-flex gap-3">
                                            <select class="form-control selectsearch search_services_item"
                                                id="searchservicestext" name="searchservicestext">
                                                <option value="" disabled selected>Select Services</option>
                                                @if (!empty($content->service_items))
                                                    @foreach ($content->service_items as $service)
                                                        <option value="{{ $service->id }}">
                                                            {{ $service->item_name }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            <button type="button"
                            ...
                            <div class="row" id="payment_term">
                                ...
                                <div class="col-lg-4 col-sm-12 pt-3 ps-4">
                                    ...
                                    <select class="form-select form-control payment_term_id" name="payment_term_id"
                                        id="payment_term_id">
                                        <option selected disabled value="">
                                            {{ __('crm.select_payment_term') }}</option>
                                        @if (!empty($content->paymentterms))
    ...
    @push('scripts')
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#addbuttom").on("click", function() {
                    ...
                    html = `<tr class="addmore">
                        ...
                        <td>
                            <input name="unit_price[]" type="number" onkeyup="calculation(${i})" class="form-control unit_price" id="unit_price_${i}" placeholder="{{ __('crm.unit_price') }}" value="" required step="any" >
                            <div class="invalid-feedback">
                                {{ __('crm.unit_price_error') }}
                            </div>
                        </td>
                ...
                $("#addServicebuttom").on("click", function() {
                    ...
                    html = `<tr class="addmore">
                        ...
                        <td>
                            <input name="discount[]" type="number" class="form-control discount" id="discount_${i}" placeholder="{{ __('crm.discount') }}" onkeyup="calculation(${i})" value="0" step="any">
                            <div class="invalid-feedback">
                                {{ __('crm.discount_error') }}
                            </div>
                        </td>
                                    ...
                                    <td colspan="8"> 
                                        <table class="w-100"> 
                                            <tr >
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-danger btn-sm remove" value="${product_id}"><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"> <line x1="18" y1="6" x2="6" y2="18"></line> <line x1="6" y1="6" x2="18" y2="18"></line> </svg> </button>
                                                </td>
                                            </tr> `;
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $.each(response.taxGroup.tax_info, function(index, DBInfo) {
                                if ($('#price_enabled').find(":selected").attr('value') ==
                                    "1") {
                                    var tax_per = (tax_amount * DBInfo.tax_percent) / 100;
                                } else {
                                    var tax_per = tax_amount * Number(DBInfo.tax_percent) /
                                        (100 + Number(DBInfo.tax_percent));
                                }
                                taxPer += tax_per;
                            ...
                            if (response != '') {
                                html += ` 
                                        <tr class="addmore cls-${product_id}">
                                            ...
                                            <td class="text-center ">
                                                <input name="unit_price[]" type="number" onkeyup="calculation(${product_id},'','')"
                                                    class="form-control unit_price" id="unit_price_${product_id}" placeholder="{{ __('crm.unit_price') }}"
                                                    value="${response.item_price}" step="any" >
                                                <div class="invalid-feedback">
                                                    {{ __('crm.unit_price_error') }}
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <input name="discount[]" type="text" class="form-control discount" id="discount_${product_id}"  onkeyup="calculation(${product_id})" placeholder="{{ __('crm.discount') }}" value="0" step="any">
                                            </td> 
                                            <td>
                                                <input name="taxable_amount[]" type="text" class="form-control taxable_amount"
            ...
            function calculation(i, attr_prc = 0, calcWholeprice = '') {
                ...
                $('#amount_' + i).val(parseFloat(data).toFixed(2));
                calculate_sub_total();
                ship_disc();
                    ...
                    $.each(DBTax_grp_data, function(index, DBTax_grp) {
                        if (tax_grp_id == DBTax_grp.tax_group_id) {
                            ...
                            $.each(DBTax_grp.tax_info, function(index, DBInfo) {
                                ...
                                var taxableAmt = $("#taxable_amount_"+i).val();
                                // alert(taxableAmt);

                                // if ($('#price_enabled').find(":selected").attr('value') == "1") {
                                    var tax_per = (taxableAmt * DBInfo.tax_percent) / 100;
                                    // ($taxable_amount[$key] * $tax->tax_percent)/100;
                                // } else {

                                //     var tax_per = taxableAmt * Number(DBInfo.tax_percent) / (100 + Number(DBInfo.tax_percent));
                                //     // var tax_per = (originalNumber * percentage) / 100;
                                // }
            ...
            function calculate_sub_total() {
                ...
                $('.addmore').each(function() {
                    ...
                    if ($('#price_enabled').find(":selected").attr('value') == "1") {
                        $('#sub_total').val(parseFloat(sum - totalTax).toFixed(2));
                        $('#total_tax_amount').val(parseFloat(sum - totalTax).toFixed(2));
            ...
            function ship_disc() {
                ...
                // var sub_total = $('#finalUnitPrice').val();
                ...
                // } else {
                //     // var tax_amount = $('.total_tax').text();
                //     var tax_amount = $("#totaltaxAmount").val();
                //     if(tax_amount>0)
                ...
                $('.payment_term_id').change(function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            var html =
                                `<h5 class="mt-4"> Advance : ${ad_amount} Balance : ${bal_amount} </h5>`;
