                    ...
                    <div class="row ">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="invoice_title" value="{{  $content->app_invoice->invoice_title }}" > 
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    @if ($content->invoice_type == 'products')
                                    ...
                                    <table class="table table_wrapper create_table">
                                            ...
                                            @if (!empty($content->app_invoice))
                                                ...
                                                <tr class="addmore">
                                                    <td colspan="8"> 
                                                        ...
                                                        <tr >
                                                            <td style="width:20%;">
                                                                <input type="hidden" name="invoice_item_id[]" value="{{$quoteItem->id}}"/>
                                                                ...
                                                                <input type="hidden" name="item_id[]" value="{{$quoteItem->item_id??''}}">
                                                            ...
                                                            <td class="text-center "  style="width:10%;">
                                                                ...
                                                                <input type="hidden" value='{{ json_encode(0) }}' data="json" id="bulk_price_{{ $key + 1 }}">
                                                            <td style="width:10%;">
                                                                ...
                                                                value="{{ $quoteItem->unit_price ?? '' }}" step="any"  > 
                                                            </td>
                                                            <td style="width:15%;">
                                                                <input name="discount[]" type="text"
                                                                    ...
                                                                    value="{{ $quoteItem->discount ?? 0 }}" step="any">
                                                            </td>
                                                            <td style="width:15%;">
                                                            ...
                                                            <td class="text-center tax_outer" style="width:15%;" >
                                                                ...
                                                                <select
                                                                    ...
                                                                    name="tax_group_id[]"
                                                                    id="tax_{{ $key + 1 }}" style="width:100px">
                                                                    ...
                                                                    <td style="max-width:120px;">
                                                                        <div class="row g-3 align-items-center">
                                                                            <div class="col-auto d-flex gap-2 mb-2">
                                                                                <label
                                                                                    for="staticEmail"
                                                                                    class="col-form-label w-100">{{ $attribute->option_name }}</label>
                                                                                <select
                                                ...
                                                <tr class="addmore">
                                                    ...
                                                    <td class="text-center ">
                                                        <input name="unit_price[]" type="number"
                                                            ...
                                                            id="unit_price_1"
                                                            placeholder="{{ __('crm.unit_price') }}" value="" step="any" >
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <td class="text-center">
                                                        <input name="discount[]" type="number"
                                                            ...
                                                            onkeyup="discount(1)"
                                                            placeholder="{{ __('crm.discount') }}" value="0" step="any">
                                                        <div class="invalid-feedback">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    @php
                                                        $totalAmt = $content->app_invoice->final_cost;
                                                        $shipping = $content->app_invoice->shipping_cost;
                                                        $final_cost = $totalAmt-$shipping;

                                                    @endphp
                                                    <input name="test" id="total_cost" type="number" value="{{ $final_cost ?? 0 }}" class="form-control"  readonly required>
                                                </td>
                                                <td>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-sm-12 pt-3 ps-4">
                                ...
                                <textarea name="note" rows="1" class="form-control">{{ $content->app_invoice->note ?? '' }}</textarea>
                                <div class="invalid-feedback">
                                    {{ __('crm.select_customer') }}
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-12 pt-3 ps-4">  
                                <input name="disc" type="hidden" class="form-control totalDiscount" value="{{ $content->app_invoice->discount ?? 1 }}" onkeyup="totalDisc()"> 

                                <label for="quotation_label" class="form-label">{{ __('crm.shipping') }}</label>
                                    <input name="shipping_cost" type="number" value="{{ $content->app_invoice->shipping_cost ?? 0 }}" class="form-control" id="shipping" onkeyup="ship_disc()">
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-lg-4 col-sm-12 pt-3 ps-4">
                                @if (!empty($content->taxTypeIds))
                                    ...
                                    @endforeach
                                @endif  <span class="total_tax d-none" >{{ $content->app_invoice->total_tax ?? 0 }} </span> 
                                <label for="quotation_label" class="form-label">{{ __('crm.total') }}</label>
                                
                                <input name="final_cost" type="number" class="form-control" value="{{ $content->app_invoice->final_cost ?? 0 }}" id="finaltotal">
                            </div>
                            <div class="col-lg-4 col-sm-12 pt-3 ps-4"> 
                                <label for="quotation_label" class="form-label">{{ __('crm.payment_term') }}</label>
                                <select class="form-select form-control payment_term_id" id="payment_term_id" name="payment_term_id">
                                    <option selected disabled value=""> {{ __('crm.select_payment_term') }}</option>
                            ...
                            <div class="col-lg-4 col-sm-12 pt-3 ps-4" id="paymentTerm">
                                @php
                                    $payment_component = json_decode($content->app_invoice->payment_component); 
                                @endphp
                                @if(!empty($payment_component->Term))
                                <h5 class="mt-4"> Advance : {{$payment_component->Term->advance->amount ?? ''}}  Balance : {{$payment_component->Term->balance->amount}} </h5>
                    ...
                    <!-- Start invoice type services -->
                                                ...
                                                <tr class="addmore">
                                                    ...
                                                    <td class="text-center">
                                                        <input name="item_cost[]" type="number"
                                                            ...
                                                            value="" required>
                                                        <div class="invalid-feedback" step="any" >
                                                            {{ __('crm.amount_error') }}
                                                        </div>
                                                    </td>
                                                    <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 pt-3 ps-4">  
                                ...
                                <input name="shipping_cost" type="hidden" value="{{ $content->app_invoice->shipping_cost ?? 0 }}" class="form-control" id="shipping" onkeyup="ship_disc()"> 
                                            @if (!empty($content->taxTypeIds))
                                                @foreach ($content->taxTypeIds as $taxTypeId)
                                                    <span class="d-none" id='{{ 'tax_type_ID_XYD' . $taxTypeId }}'
                                                        value="{{ $taxTypeId }}"></span>
                                        ...
                                        <input name="final" type="hidden" class="form-control"
                                            value="{{ $content->app_invoice->final_cost ?? 0 }}" id="finaltotal"
                                            readonly> 
                                    <input type="hidden" name="total_tax"
                                        value="{{ $content->app_invoice->total_tax ?? 0 }}" id="total_tax"> 
                            </div>
    ...
    <script src="{{ asset('asset/js/iCheck/icheck.min.js') }}"></script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $("#addbuttom").on("click", function() {
                    ...
                    html = `<tr class="addmore">
                        ...
                        <input type="hidden" value="1"  id="min_prod_qty_${i}">
                            <input name="discount[]" type="number" class="form-control discount" id="discount_${i}" placeholder="{{ __('crm.discount') }}" onkeyup="discount(${i})" value="0" step="any">
                            <div class="invalid-feedback">
                                {{ __('crm.discount_error') }}
                            </div>
                        </td>
                ...
                $("#addServicebuttom").on("click", function() {
                    ...
                    html = `<tr class="addmore">
                        ...
                        <td class="text-center ">
                            <input name="unit_price[]" type="number" onkeyup="calculation(${i})"
                        ...
                        <td>
                        <input type="hidden" value="1"  id="min_prod_qty_${i}">
                            <input name="discount[]" type="text" class="form-control discount" id="discount_${i}" placeholder="{{ __('crm.discount') }}" onkeyup="calculation(${i})" value="0" step="any" >
                        </td>
                                ...
                                <td colspan="12">
                                    ...
                                    <table>
                                        ...
                                        <input type="hidden" name="invoice_item_id[]" value="0"/>
                                            ...
                                            <td class="text-center ">
                                                <input name="unit_price[]" type="number" onkeyup="calculation(${product_id},'','')"
                                                    class="form-control unit_price" id="unit_price_${product_id}" placeholder="{{ __('crm.unit_price') }}"
                                                    value="${response.attribute_sale_price}" step="any" >
                                                <div class="invalid-feedback">
                                                    {{ __('crm.unit_price_error') }}
                                                </div>
                                            ...
                                            <td class="text-center">
                                                <input name="discount[]" type="number"
                                                    ...
                                                    onkeyup="discount(${product_id})" placeholder="{{ __('crm.discount') }}" value="${response.discount}" step="any">
                                                <div class="invalid-feedback">
                                                    {{ __('crm.discount_error') }}
                                                </div>
                                            </td>
            ...
            function totalDisc() {
                ...
                $('#finaltotal').val(parseFloat(grand_total).toFixed(2));
                $('#total_cost').val(parseFloat(grand_total).toFixed(2));
            }
            ...
            function calculate_sub_total() {
                ...
                $('.addmore').each(function() {
                    ...
                    if ($('#price_enabled').find(":selected").attr('value') == "1") {
                        ...
                        $('#finaltotal').val(parseFloat(sum).toFixed(2));
                        ...
                        $('#finaltotal').val(parseFloat(sum + totalTax).toFixed(2));
            ...
            function ship_disc() {
                ...
                if (shipping.length > 0 && typeof(shipping) != "undefined" && shipping !== null) {
                    var total_amount = Number(sub_total) + Number(shipping);
                    $('#finaltotal').val(total_amount); 
                } else {
                    $('#finaltotal').val(sub_total); 
                }
                paymentTerms();
            }
