        ...
        <div class="pd-x-0 pd-lg-x-10 pd-xl-x-0">
            <div class="d-sm-flex align-items-center justify-content-between">
                ...
                <div class="mg-t-20 mg-sm-t-0">
                    ...
                    <a class="btn btn-primary mg-l-5 shareBtn"  data-bs-toggle="modal" data-bs-target="#sharemodal"  href="javascript:void();"><svg
                            ...
                            @foreach ($quotation->crm_quotation_item as $key => $item)
                                ...
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell tx-color-03"> 
                                        {{ $item->item_name }}<br/>
                                        @if(!empty($item->product_data->productAttribute))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content col-12">
            ...
            <div class="icon-container2 d-flex">
                <div class="smd">
                    <a class="text-dark" href="https://api.whatsapp.com/send?text={{ $website_url.'/portal/quotation/'.$quotation->quotation_no }}" target="_blank">
                ...
                <div class="smd">
                    <a class="text-dark" href="mailto:?subject=Quotation :{{$quotation->quotation_no}} &body=Follow this link to see details : {{$website_url.'/portal/quotation/'.$quotation->quotation_no}}">
            ...
            <div class="modal-footer">
                ...
                <div class="row">
                    <div class="col-10">
                        <input class="col-10 ur  form-control" type="url" 
                        id="myInput" value="{{$website_url.'/portal/quotation/'.$quotation->quotation_no}}" aria-describedby="inputGroup-sizing-default" style="height: 40px;">
                        </div>
                        <div class="col-2">
                            <button class="cpy" onclick="myFunction()"><i class="fa fa-clone"  style="font-size: 1rem;"></i></button>
                        </div>
