<x-app-layout>
    ...
    {{-- @dd(\App\Helper\Helper::CheckPermission($pageAccess, 'view')) --}}
        ...
        <div class="contact-content">
            <div class="contact-content-header mg-b-20 mg-lg-b-25 mg-xl-b-30">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" id="atxnHeadTab">
                        <a href="#txnHead"
                            class="nav-link {{ request()->tab == 'txn-head' || !isset(request()->tab) ? 'active' : '' }} "
                            data-toggle="tab">{{ __('sales.transaction_head') }}</a>

                    </li>


                    <li class="nav-item" id="TxnTab">
                        <a href="#expanse-catgeory" class="nav-link {{ request()->tab == 'category' ? 'active' : '' }}"
                            data-toggle="tab">{{ __('sales.txn_category') }}</a>
                    </li>

                    <li class="nav-item" id="accountTab">
                        <a href="#account" class="nav-link {{ request()->tab == 'account' ? 'active' : '' }}"
                            data-toggle="tab">{{ __('sales.account') }}</a>
                    </li>
            ...
            <div class="card contact-content-body">
                <div class="tab-content">
                    ...
                    <div id="txnHead"
                        class="tab-pane {{ request()->tab == 'txn-head' || !isset(request()->tab) ? 'active' : '' }} ">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 class="tx-15 mg-b-0">Transaction Head</h6>
                                @if (\App\Helper\Helper::CheckPermission($pageAccess, 'add') == 'true')
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#addTxnHead"
                                        id="add_title_btn" class="btn btn-primary">
                                        <i data-feather="plus"></i><span class="d-none d-sm-inline mg-l-5">Add
                                            Head</span>
                                    </a>
                                @endif
                            </div>
                                            ...
                                            @forelse ($content->AccTxnHad as $key => $AccTxn)
                                                <tr>
                                                    <td><input type="number"
                                                            class="col-xs-1 resultTitle width1 text-center me-2"
                                                            data-id="{{ $AccTxn->id }}" placeholder=""
                                                            value="{{ $AccTxn->sort_order }}" style="width:50px;">
                                                        {{ ucwords($AccTxn->head_title) }} <i
                                                            class="fa fa-arrow-circle-down" aria-hidden="true"></i></td>
                                                    <td></td>
                                                    <td>
                                                        <span
                                                            class="badge  {{ $AccTxn->dr_cr == 'dr' ? 'text-bg-danger' : 'text-bg-primary' }}">{{ $AccTxn->dr_cr }}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    @if (\App\Helper\Helper::CheckPermission($pageAccess, 'update') === 'true')
                                                        <td
                                                            ...
                                                            <a href="#" data-id="{{ $AccTxn->id }}"
                                                                ...
                                                                data-bs-target="#modalEditTxnHead"
                                                ...
                                                @foreach ($AccTxn->child as $key => $child)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number"
                                                                ...
                                                                style="width:50px;">{{ ucwords($child->head_title) }}
                                                        </td>
                                                        <td>
                                                            <span
                                                                class="badge  {{ $child->dr_cr == 'dr' ? 'text-bg-danger' : 'text-bg-primary' }}">{{ $child->dr_cr }}</span>
                                                        </td>
                                                        <td>
                                                            <div class="custom-control custom-switch">
                                                                <input type="checkbox"
                    ...
                    <div id="expanse-catgeory" class="tab-pane {{ request()->tab == 'category' ? 'active' : '' }}">
                        <div class="card-header">
                            <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <tbody>
                                            @forelse ($content->crmexpansecategory as $key => $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span
                                                            class="badge  {{ $category->dr_cr == 'dr' ? 'text-bg-danger' : 'text-bg-primary' }}">{{ $category->dr_cr }}</span>
                                                    </td>
                                                    <td>
                                                        <input type="number"
                                                            class="col-xs-1 categorySortOrder width1 text-center gap-2"
                                                    ...
                                                    <td class="d-flex align-items-center justify-content-between">
                                                        @if (\App\Helper\Helper::CheckPermission($pageAccess, 'update') == 'true')
                                                            <a href="#" data-id="{{ $category->id }}"
                                                                data-bs-target="#modalEditexpense"
                                                                data-bs-toggle="modal"
                                        ...
                                        <tbody>
                                            @forelse ($content->appAccounts as $key => $appAccount)
                                                <tr>
                                                    ...
                                                    <td> {{ $appAccount->account_type == 1 ? 'Bank Account' : 'Credit Card' }}
                                                    </td>
                                                    ...
                                                    <td class="d-flex align-items-center justify-content-center">
                                                        @if (\App\Helper\Helper::CheckPermission($pageAccess, 'update') == 'true')
                                                            <a href="#" data-bs-target="#modalEditAccount"
                                                                data-bs-toggle="modal"
                                                                data-id="{{ $appAccount->id }}"
    ...
    <!-------------- Edit expense Modal --------------->
    <div class="modal fade" id="modalEditexpense" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                    ...
                    <form class="needs-validation novalidate" id="edit_expense_title_form" novalidate>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                                ...
                                <input name="expense_name" id="editexpense_name" type="text" class="form-control"
                            ...
                            <div class="form-group col-lg-12">
                                <label class="form-label">{{ __('sales.cateDesc') }}<span
                                        class="text-danger"></span></label>
                                <textarea name="expense_category" id="editexpense_description" class="form-control"
                                    placeholder="{{ __('sales.category_desc_placeholder') }}"></textarea>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-icon position-relative">
                                    <select class="form-control" id="update_category_type" name="category_type"
                                        required>
                                        <option selected disabled value="">
                                            {{ __('sales.select_category_type') }}
                                        </option>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                ...
                                <input name="account_title" placeholder="{{ __('sales.account_title_placeholder') }}"
                                    class="form-control" id="edit_account_title" required />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="number" step="0.0001" name="opening_balence"
                                    ...
                                    placeholder="{{ __('sales.opening_balence_placeholder') }}"
                                    class="form-control" />
                        ...
                        <div class="row">
                            <div class="col-sm-12 mt-4">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input  section_type is-invalid type parentselectVal"
                                        type="radio" name="section_type" id="update_head_section_type"
                                        value="0">
    ...
    <!--start add modal-->
    <div class="modal fade" id="expanse_category_add" tabindex="-1" role="dialog"
                    ...
                    <form method="POST" id="expense_add_userForm" class="needs-validation mg-b-0" novalidate>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-12">
                                <label class="form-label">{{ __('sales.cateDesc') }}<span
                                        class="text-danger"></span></label>
                                <textarea name="expense_category" id="expense_category" class="form-control"
                                    placeholder="{{ __('sales.category_desc_placeholder') }}"></textarea>
                                <div class="invalid-feedback">
    ...
    <!--start add modal-->
    <div class="modal fade" id="expanse_account_add" tabindex="-1" role="dialog"
        aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modalselect2" role="document">
            <div class="modal-content tx-14">
                <div class="modal-header">
    ...
    <div class="modal fade" id="addTxnHead" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content tx-14">
                <div class="modal-header">
                ...
                $('.head_edit_btn').on('click', function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $('#update_head_type option[value="' + sec.dr_cr + '"]').prop(
                                'selected', true);
                            ...
                            if (sec.parent_id != '0') {
                                ...
                                $("#update_head_title").val(sec.head_title);
                                $('#status_head option[value="' + sec.status + '"]').prop(
                                    'selected',
                                    true);
                ...
                $(document).on("submit", "#edit_result_title_form", function(e) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            window.location.href =
                                "{{ route('accounts.setting.index', ['tab=txn-head']) }}";
