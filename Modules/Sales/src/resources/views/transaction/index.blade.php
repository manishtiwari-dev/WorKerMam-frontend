                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        @if (\App\Helper\Helper::CheckPermission($pageAccess, 'add') == 'true')
                            <a href="{{ route('accounts.transaction.create', ['type=expense']) }}"
                                ...
                                </svg>{{ __('sales.add_expense') }}</i></a>
                            <a href="{{ route('accounts.transaction.create', ['type=income']) }}"
                                class="btn btn-sm btn-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus mg-r-5">
                                    <line x1="12" y1="5" x2="12" y2="19"></line>
                                    <line x1="5" y1="12" x2="19" y2="12"></line>
                                </svg>{{ __('sales.add_income') }}</i></a>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-3 mb-2 tagselect">
                        ...
                        <select class="form-control select-filter select2" data-placeholder="Invoice Status"
                            name="txncategory" id="txncategory">
                        ...
                        <tbody>
                            @forelse($content->app_transactions as $key => $transaction)
                                <tr>
                                    ...
                                    <td>
                                        <span
                                            class="badge  {{ $transaction->dr_cr == 'dr' ? 'text-bg-danger' : 'text-bg-success' }}">{{ $transaction->dr_cr == 'cr' ? 'Cr' : 'Dr' }}</span>
                                    </td>
                                    <!-- <td></td> -->
