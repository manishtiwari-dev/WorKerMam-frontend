...
Route::group(
    ...
    function () {
        ...
        Route::post('change-guest-user', [CustomerController::class, 'changeGuest'])->name('change-guest-user');
        ...
        Route::get('/service-data', [QuotationController::class, 'serviceData'])->name('service-data');

        Route::post('/service-delete/{id}', [QuotationController::class, 'ServiceDelete'])->name('ServiceDelete'); 
        Route::post('/service-update/{id}', [QuotationController::class, 'ServiceUpdate'])->name('ServiceUpdate'); 
        ...
        Route::post('/payment-term', [InvoiceController::class, 'PaymentTerm'])->name('PaymentTerm');   
...
function () {
    ...
    Route::post('report-chart', [ReportsController::class, 'ReportChart'])->name('report-chart');

    Route::post('report-Ann-chart', [ReportsController::class, 'ReportAnnChart'])->name('report-Ann-chart');
